...
from gomoku_zero.agent.player_gomoku import HistoryItem
from gomoku_zero.agent.player_gomoku import GomokuPlayer, Player
...
class PlayWithHuman:
    ...
    def start_game(self, human_is_black):
        ...
        self.ai = GomokuPlayer(self.config, self.model)
